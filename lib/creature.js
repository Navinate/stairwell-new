...
class Creature {
  ...
  drawCreatures(time) {
    ...
    image(tails[0], this.x3, this.y3, 60 * this.size, 60 * this.size);
    image(bodies[0], this.x2, this.y2, 60 * this.size, 60 * this.size);
    image(heads[0], this.x1, this.y1, 60 * this.size, 60 * this.size);
